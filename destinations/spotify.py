...
class Spotify:
    ...
    def __init__(self, config):
        ...
        # user interaction.
        self._token_prompt()
        print('Authenticated to Spotify as ' + self.spotify.me()['display_name'])

    def _token_prompt(self):
        scope = 'playlist-modify-public'
        redirect_uri = "http://127.0.0.1/spotify"
        token = spotipy.util.prompt_for_user_token(self.config['username'],
                                                   scope=scope,
    ...
    def save(self, track):
        ...
        try:
            ...
            results = self.spotify.user_playlist_add_tracks(self.config['username'],
